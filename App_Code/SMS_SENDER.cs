...
public class SMSC
{
	...
	const string SMSC_LOGIN = "roman-kmail@mail.ru";		// логин клиента
	const string SMSC_PASSWORD = "ec9fcdbfaf8861d0ea091df8a513d6a4";	// пароль или MD5-хеш пароля в нижнем регистре
