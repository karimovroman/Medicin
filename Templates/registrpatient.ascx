<%@ Control Language="C#" AutoEventWireup="true" CodeFile="registrpatient.ascx.cs" Inherits="Templates_registrpatient" %>
<style type="text/css">
    .cardFile.profile {
margin: 0 0 5px 0;
}
...
<div  runat="server">
                                <span >
                                    ...
                                    <asp:Button class="tContent" ID="spec_name" runat="server" Text="ФИО пациента" OnClick="click"></asp:Button>
