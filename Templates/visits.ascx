<%@ Control Language="C#" AutoEventWireup="true" CodeFile="visits.ascx.cs" Inherits="Templates_visits" %>
<script runat="server">
</script>
...
<table style="margin-bottom: 10px">
    <tr>
        ...
        <td style="width: 200px">
            <asp:LinkButton ID="rec" runat="server" OnClick="rec_Click" Text="Перейте к карте"></asp:LinkButton>
