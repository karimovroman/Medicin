<%@ Control Language="C#" AutoEventWireup="true" CodeFile="registrdoctor.ascx.cs" Inherits="Templates_registrdoctor" %>
<style type="text/css">
    .cardFile.profile {
margin: 0 0 5px 0;
}
...
<div  runat="server">
                                <span >
                                    ...
                                    <asp:Button class="tContent" ID="spec_name" runat="server" Text="Название специализации" OnClick="click"></asp:Button>
