<%@ Control Language="C#" AutoEventWireup="true" CodeFile="regtime.ascx.cs" Inherits="Templates_regtime" %>
<style type="text/css">
    .cardFile.profile {
margin: 0 0 5px 0;
}
...
<tr>
    <td style="width:100px;text-align:center">
        <<asp:LinkButton ID="times" runat="server" OnClick="click" Text=""></asp:LinkButton>
    </td>
</tr>