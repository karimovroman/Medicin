<%@ Control Language="C#" AutoEventWireup="true" CodeFile="mo.ascx.cs" Inherits="Templates_mo" %>
<style type="text/css">
    .cardFile.profile {
margin: 0 0 5px 0;
}
...
<div  runat="server">
                                <span >
                                    ...
                                    <asp:Button class="tContent" ID="spec_name" runat="server" Text="Учреждение" OnClick="click"></asp:Button>
