<%@ Page Title="Записаться на прием: Назначение времени" Language="C#" MasterPageFile="~/SitePatient.master" AutoEventWireup="true" CodeFile="recordtime.aspx.cs" Inherits="Recordtime" %>
    ...
    <div style="">
        ...
        <table>
            ...
            <tr style="text-align: center;vertical-align:top">
                <td style="width: 50px">
                    <div runat="server"><table style="vertical-align:top">
                        <asp:PlaceHolder ID="pn" runat="server"></asp:PlaceHolder></table>
                    </div>
                </td>
