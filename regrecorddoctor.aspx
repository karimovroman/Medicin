<%@ Page Title="Записаться на прием: Выбор доктора" Language="C#" MasterPageFile="~/SiteRegistr.master" AutoEventWireup="true" CodeFile="regrecorddoctor.aspx.cs" Inherits="regrecorddoctor" %>
<%@ Reference Control="~/Templates/registrdoctor.ascx" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    void Page_Load(Object sender, EventArgs e)
    {
        ...
        {
            if (d.Idspec == Convert.ToInt32(specid))
            {
                alldc.Add(d);
            }
        }
        ...
        if (alldc.Count() > 0)
        {
            ...
            {
                Templates_registrdoctor cntrl = (Templates_registrdoctor)LoadControl("Templates/registrdoctor.ascx");
