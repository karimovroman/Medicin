...
public partial class Reg_doctor : System.Web.UI.Page
{
    public int next1 = 0;
    public int prev1 = 0;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (day + 1 - (dayofweek - 1) > dim)
            day = 1;
        ch22.Text = Convert.ToString(day + 1 - (dayofweek - 1));
        if (day + 2 - (dayofweek - 1) > dim)
            day = 1;
        ch33.Text = Convert.ToString(day + 2 - (dayofweek - 1));
        if (day + 3 - (dayofweek - 1) > dim)
            day = 1;
        ch44.Text = Convert.ToString(day + 3 - (dayofweek - 1));
        if (day + 4 - (dayofweek - 1) > dim)
            day = 1;
        ch55.Text = Convert.ToString(day + 4 - (dayofweek - 1));
        if (day + 5 - (dayofweek - 1) > dim)
            day = 1;
        ch66.Text = Convert.ToString(day + 5 - (dayofweek - 1));
        if (day + 6 - (dayofweek - 1) > dim)
            day = 1;
        ch77.Text = Convert.ToString(day + 6 - (dayofweek - 1));

        if (day < 8)
            day += 7;
        else
            day = Convert.ToInt32(DateTime.Now.Day) + 14;
          
        if (day - (dayofweek - 1) > dim)
            day = 2;
        ch111.Text = Convert.ToString(day - (dayofweek - 1));
        if (day + 1 - (dayofweek - 1) > dim)
            day = 2;
        ch222.Text = Convert.ToString(day + 1 - (dayofweek - 1));
        if (day + 2 - (dayofweek - 1) > dim)
            day = 2;
        ch333.Text = Convert.ToString(day + 2 - (dayofweek - 1));
        if (day + 3 - (dayofweek - 1) > dim)
            day = 2;
        ch444.Text = Convert.ToString(day + 3 - (dayofweek - 1));
        if (day + 4 - (dayofweek - 1) > dim)
            day = 2;
        ch555.Text = Convert.ToString(day + 4 - (dayofweek - 1));
        if (day + 5 - (dayofweek - 1) > dim)
            day = 2;
        ch666.Text = Convert.ToString(day + 5 - (dayofweek - 1));
        if (day + 6 - (dayofweek - 1) > dim)
            day = 2;
        ch777.Text = Convert.ToString(day + 6 - (dayofweek - 1));
